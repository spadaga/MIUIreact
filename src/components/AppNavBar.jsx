...
const pages = ['Quotes', 'Jobs', 'Invoice'];
...
function AppNavBar({ theme, toggleTheme }) {
 ...
 <AdsClickIcon sx={{ display: { xs: 'flex', md: 'flex' }, mr: 1 }} />
        ...
        />
          ...
          <Box>
            <FormControlLabel
              control={<Switch color='warning' checked={theme} onChange={toggleTheme} />}
              label={theme === true ? 'Dark Mode' : 'Light Mode'}
            />
          </Box>
    ...
    <MyDrawer isOpen={drawerOpen} toggleDrawer={toggleDrawer}/>
    </>
  );
}
